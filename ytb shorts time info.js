...
// @grant        GM.getValue
// @grant        GM.setValue
// @updateURL   https://raw.githubusercontent.com/aung777/scriptGue/main/ytb%20shorts%20time%20info.js
// @downloadURL https://raw.githubusercontent.com/aung777/scriptGue/main/ytb%20shorts%20time%20info.js
// ==/UserScript==
...
function updateVidElem() {
  ...
  if ($(reel).find("#byts-progbar").length === 0) {
    if ($("#byts-progbar").length === 0) {
      $(reel).append(
        '<div id="byts-progbar" style="user-select: none; cursor: pointer; width: 100%; height: 14px; background-color: #343434; position: absolute; margin-top: -20px; border-radius: 10px;"></div>'
      );
    } else {
